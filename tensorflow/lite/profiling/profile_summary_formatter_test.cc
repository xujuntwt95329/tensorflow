...
TEST(SummaryWriterTest, MultiSubgraphOutputStringForProto) {
  ...
  op_profile_data_1.set_first_inference_microseconds(10);
  op_profile_data_1.set_avg_inference_microseconds(10);
  op_profile_data_1.set_times_called(1);
  op_profile_data_1.set_mem_kb(10);
  ...
  op_profile_data_2.set_first_inference_microseconds(15);
  op_profile_data_2.set_avg_inference_microseconds(15);
  op_profile_data_2.set_times_called(1);
  op_profile_data_2.set_mem_kb(10);
  ...
  op_profile_data_3.set_first_inference_microseconds(10);
  op_profile_data_3.set_avg_inference_microseconds(10);
  op_profile_data_3.set_times_called(1);
  op_profile_data_3.set_mem_kb(10);
...
TEST(SummaryWriterTest, MultiSubgraphHandleOutputForProto) {
  ...
  op_profile_data_4->set_first_inference_microseconds(10);
  op_profile_data_4->set_avg_inference_microseconds(10);
  op_profile_data_4->set_times_called(1);
  op_profile_data_4->set_mem_kb(10);
  ...
  op_profile_data_init_1->set_first_inference_microseconds(10);
  op_profile_data_init_1->set_avg_inference_microseconds(10);
  op_profile_data_init_1->set_times_called(1);
  op_profile_data_init_1->set_mem_kb(10);
