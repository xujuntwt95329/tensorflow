...
// The API for reporting and using batch statistics such as the average batch
// costs.
//
// All these statistics can also be retrieved from metrics reported by various
// modules (mostly in batch_resource_base), but it would be slow. This API, on
// the other hand, was designed to be queried on every request.
//
